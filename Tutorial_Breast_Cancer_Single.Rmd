...
We can also look at these data interactively. This function can be a little slow but also very useful to visualize expression in different projection spaces. We won't run this
