...
- Tried on the student's R studio and it works fine for 100 genes
...
```{r}
top.features <- head(SpatiallyVariableFeatures(mouse_brain_sa, selection.method = "markvariogram"), 6)
SpatialFeaturePlot(mouse_brain_sa, features = top.features, ncol = 3, alpha = c(0.1, 1))
```
